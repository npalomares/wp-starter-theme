...
function roots_scripts() {
  wp_enqueue_style('roots_bootstrap', '//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/css/bootstrap-combined.min.css', false, null);
  ...
  wp_register_script('roots_bootstrap', '//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/js/bootstrap.min.js', false, null, true);
