# Fester's Starter Theme

This is just the Roots theme with some of the modifications that I always end up doing (using the Bootstrap CDN, removing a few functions, etc)
